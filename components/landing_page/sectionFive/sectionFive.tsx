	...
	return (
		<section className="flex flex-col responsiveWidth gap-y-4 sm:gap-y-8 items-center mt-44">
			...
			<p className="text-colorGray text-sm sm:text-lg md:text-xl max-w-3xl tracking-wide ">
				"Do It helps keep me organized - I truly could not live without it! Allows me to prioritize my tasks in a super simple way. I definitely recommend Do It to
				everyone - I really think it's the best to-do list app available!"
			</p>
