...
export default function SectionOne(props: { font: NextFont }) {
	return (
		<section className="relative flex w-screen flex-col items-center justify-center gap-y-8 bg-gradient-to-br from-[--background-rgb] to-[--background-rgb-darker] px-10 pb-40 pt-28 text-center md:px-20 md:pt-32 lg:px-24 lg:py-40 xl:px-32">
			<h1 className={'m-0 text-4xl tracking-wider text-mainText md:text-5xl lg:text-6xl xl:text-7xl ' + props.font.className}>
				Lorem ipsum, <br className="hidden lg:block" />
				dolor sit amet adipisicing.
			</h1>
			<p className="text-md text-mediumText md:text-lg lg:text-xl xl:text-2xl">
			...
			<div className="overflow-hidden rounded-3xl border-b-1 border-lightText/40 bg-gradient-to-b from-transparent to-[--background-rgb-darker] px-8 md:px-12 lg:px-16 xl:px-20">
				<picture>
